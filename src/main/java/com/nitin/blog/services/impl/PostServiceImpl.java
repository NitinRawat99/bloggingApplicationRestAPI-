...
import com.nitin.blog.repositories.PostRepo;
import com.nitin.blog.repositories.UserRepo;
import com.nitin.blog.services.PostService;
...
public class PostServiceImpl implements PostService 
{
	...
	public PostDto createPost(PostDto postDto,Integer userId,Integer categoryId) 
	{
		...
		Category category = this.categoryRepo.findById(categoryId).orElseThrow(() -> new ResourceNotFoundException("Category","cateogry id",categoryId));
